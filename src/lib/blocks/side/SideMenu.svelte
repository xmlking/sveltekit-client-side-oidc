<script lang="ts">
	...
	import { AcademicCap, ArrowRightOnRectangle, Bell, ChartPie, ClipboardDocumentList, Cog, HandRaised, Squares2x2, Star, UserGroup, Users } from 'svelte-heros-v2';
	...
	<Sidebar>
		<SidebarWrapper {divClass}>
			<SidebarGroup>
				...
				<SidebarItem label="Profile" href="/dashboard/profile" active={activeUrl === '/dashboard/profile'}>
